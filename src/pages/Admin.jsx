  ...
  return (
    <section className="min-h-screen bg-[#fafaf9] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* SUCCESS / ERROR PORTAL */}
        {notification && (
          <div className="fixed bottom-10 left-1/2 -translate-x-1/2 z-[100] animate-[fadeInUp_0.4s_ease]">

            <div
              className={`px-8 py-4 rounded-2xl shadow-2xl border flex items-center gap-3 backdrop-blur-xl
              ${
                notification.type === "success"
                  ? "bg-[#2d241e] text-white border-amber-500/30"
